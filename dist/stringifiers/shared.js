...
function interpretForKeysetPaging(node, dialect) {
  ...
  if (node.sortKey) {
    ...
    if ((_ref7 = node) != null ? (_ref7 = _ref7.args) != null ? _ref7.last : _ref7 : _ref7) {
      descending = !descending;
    }
    for (let column of (0, _util.wrap)(sortKey.key)) {
      order.columns[column] = descending ? 'DESC' : 'ASC';
  ...
  let limit = ['mariadb', 'mysql', 'oracle'].includes(name) ? '18446744073709551615' : 'ALL';
  let whereCondition = '';
  if ((_ref8 = node) != null ? (_ref8 = _ref8.args) != null ? _ref8.first : _ref8 : _ref8) {
  ...
  } else if ((_ref9 = node) != null ? (_ref9 = _ref9.args) != null ? _ref9.last : _ref9 : _ref9) {
